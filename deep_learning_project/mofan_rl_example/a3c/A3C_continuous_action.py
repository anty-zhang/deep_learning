...
MAX_EP_STEP = 200       # 每次迭代次数最大的回合数
MAX_GLOBAL_EP = 2000    # 每个worker最大的迭代次数
GLOBAL_NET_SCOPE = 'Global_Net'
UPDATE_GLOBAL_ITER = 10     # push和pull参数的间隔数
GAMMA = 0.9                 # discount
ENTROPY_BETA = 0.01
LR_A = 0.0001    # learning rate for actor
LR_C = 0.001    # learning rate for critic
GLOBAL_RUNNING_R = []       # 存储全局reward
GLOBAL_EP = 0               # 全局迭代次数
...
class ACNet(object):
    def __init__(self, scope, globalAC=None):
        ...
        if scope == GLOBAL_NET_SCOPE:   # get global network    # 判断当下建立的网络是 local 还是 global
